/*
  ...
  This sketch is used to upgrade the firmware present on an WINC1500 module
  (i.e WiFi Shield 101 MKR1000)
  
  Once this sketch has been uploaded please refer to the instructions you can
  find here https://github.com/arduino-libraries/WiFi101-FirmwareUpdater
